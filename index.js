...
const authenticateHandle = (req, res, next) => {
    let request = new oauth2_server_1.Request(req);
    let response = new oauth2_server_1.Response(res);
...
function authorize(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const code = yield server.authorize(request, response, options);
            res.json(code);
        }
        catch (error) {
...
app.post('/auth', token);
app.get('/secret', authenticateHandle, (req, res) => {
